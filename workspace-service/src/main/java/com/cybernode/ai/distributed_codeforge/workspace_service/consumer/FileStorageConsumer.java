package com.cybernode.ai.distributed_codeforge.workspace_service.consumer;


import com.cybernode.ai.distributed_codeforge.common_lib.event.FileStoreRequestEvent;
import com.cybernode.ai.distributed_codeforge.common_lib.event.FileStoreResponseEvent;
import com.cybernode.ai.distributed_codeforge.workspace_service.entity.ProcessedEvent;
import com.cybernode.ai.distributed_codeforge.workspace_service.repository.ProcessedEventRepository;
...
public class FileStorageConsumer {
    ...
    public void consumeFileEvent(FileStoreRequestEvent requestEvent) {
        ...
        try {
            ...
            projectFileService.saveFile( requestEvent.filePath(), requestEvent.content(),requestEvent.projectId());
